         ...
         <div className="invite-app">
            <div className="invite-app__body">
               <div className="invite-app__input">
                  ...
                  <input value={input} onInput={(e) => setInput(e.target.value)} placeholder='Поиск...' type="text" className="invite-app__input-field" />
               </div>
               ...
               <button onClick={openPopup} style={invited.length !== 0 ? {display: 'inline'} : {display: 'none'}} className="invite-app__btn">Отправить</button>
            </div>
         </div>
      </div>
   )
